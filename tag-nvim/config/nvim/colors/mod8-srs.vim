...
call <sid>highlight('LineNr', s:cterm02, '', '')
call <sid>highlight('SignColumn', s:cterm03, s:cterm01, '')
call <sid>highlight('SpecialKey', s:cterm03, '', '')
call <sid>highlight('StatusLine', s:cterm04, s:cterm01, 'none')
call <sid>highlight('StatusLineNC', s:cterm03, s:cterm01, 'none')
call <sid>highlight('VertSplit', s:cterm02, s:cterm01, 'none')
...
call <sid>highlight('CursorLineNr', s:cterm03, '', '')
