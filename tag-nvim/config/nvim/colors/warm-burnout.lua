...
vim.api.nvim_set_hl(0, "SnacksPickerBorder", { fg = fg_gutter, bg = bg })
vim.api.nvim_set_hl(0, "SnacksPickerBox", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerBoxBorder", { fg = fg_gutter, bg = bg })
vim.api.nvim_set_hl(0, "SnacksPickerBoxCursorLine", { link = "Visual" })
vim.api.nvim_set_hl(0, "SnacksPickerBoxFooter", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerCursorLine", { link = "Visual" })
vim.api.nvim_set_hl(0, "SnacksPickerDir", { fg = fg_gutter })
vim.api.nvim_set_hl(0, "SnacksPickerFooter", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerInput", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerInputBorder", { fg = fg_gutter, bg = bg })
vim.api.nvim_set_hl(0, "SnacksPickerInputFooter", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerInputTitle", { fg = fg })
vim.api.nvim_set_hl(0, "SnacksPickerList", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerListBorder", { fg = fg_gutter, bg = bg })
vim.api.nvim_set_hl(0, "SnacksPickerListCursorLine", { link = "Visual" })
vim.api.nvim_set_hl(0, "SnacksPickerListFooter", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerListTitle", { fg = fg })
vim.api.nvim_set_hl(0, "SnacksPickerMatch", { link = "Special" })
vim.api.nvim_set_hl(0, "SnacksPickerPreview", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerPreviewBorder", { fg = fg_gutter, bg = bg })
vim.api.nvim_set_hl(0, "SnacksPickerPreviewCursorLine", { link = "Visual" })
vim.api.nvim_set_hl(0, "SnacksPickerPreviewFooter", { link = "Normal" })
vim.api.nvim_set_hl(0, "SnacksPickerPreviewTitle", { fg = fg })
vim.api.nvim_set_hl(0, "SnacksPickerPrompt", { link = "Identifier" })
vim.api.nvim_set_hl(0, "SnacksPickerSearch", { link = "Search" })
vim.api.nvim_set_hl(0, "SnacksPickerTitle", { fg = fg, bg = bg })
vim.api.nvim_set_hl(0, "SnacksPickerTotals", { fg = fg_gutter })
vim.api.nvim_set_hl(0, "SnacksTitle", { fg = fg, bold = true })
