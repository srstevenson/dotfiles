...
vim.api.nvim_set_hl(0, "Statement", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "Conditional", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "Repeat", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "Label", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "Operator", { fg = operator })
vim.api.nvim_set_hl(0, "Keyword", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "Exception", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "PreProc", { fg = keyword })
vim.api.nvim_set_hl(0, "Include", { fg = keyword, bold = true })
...
vim.api.nvim_set_hl(0, "Type", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "StorageClass", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "Structure", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "Typedef", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "Special", { fg = operator })
vim.api.nvim_set_hl(0, "SpecialChar", { fg = regex })
vim.api.nvim_set_hl(0, "Tag", { fg = tag, bold = true })
...
vim.api.nvim_set_hl(0, "@variable.builtin", { fg = variable_lang, italic = true })
...
vim.api.nvim_set_hl(0, "@keyword", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.coroutine", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.function", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.operator", { fg = operator })
vim.api.nvim_set_hl(0, "@keyword.import", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.type", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.modifier", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.repeat", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.return", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.debug", { fg = warn })
vim.api.nvim_set_hl(0, "@keyword.exception", { fg = keyword, bold = true })
vim.api.nvim_set_hl(0, "@keyword.conditional", { fg = keyword, bold = true })
...
vim.api.nvim_set_hl(0, "@type", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@type.builtin", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@type.definition", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@type.qualifier", { fg = keyword, bold = true })

vim.api.nvim_set_hl(0, "@attribute", { fg = decorator, italic = true })
vim.api.nvim_set_hl(0, "@attribute.builtin", { fg = decorator, italic = true })

vim.api.nvim_set_hl(0, "@property", { fg = property, italic = true })
...
vim.api.nvim_set_hl(0, "@tag", { fg = tag, bold = true })
vim.api.nvim_set_hl(0, "@tag.builtin", { fg = tag, bold = true })
vim.api.nvim_set_hl(0, "@tag.attribute", { fg = attribute })
vim.api.nvim_set_hl(0, "@tag.delimiter", { fg = tag })

vim.api.nvim_set_hl(0, "@constructor", { fg = type_c, italic = true })
...
-- LSP semantic tokens
vim.api.nvim_set_hl(0, "@lsp.type.class", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.decorator", { fg = decorator, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.enum", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.enumMember", { fg = regex })
vim.api.nvim_set_hl(0, "@lsp.type.function", { fg = func })
vim.api.nvim_set_hl(0, "@lsp.type.interface", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.keyword", { fg = keyword, bold = true })
...
vim.api.nvim_set_hl(0, "@lsp.type.property", { fg = property, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.regexp", { fg = regex })
vim.api.nvim_set_hl(0, "@lsp.type.string", { fg = string_c })
vim.api.nvim_set_hl(0, "@lsp.type.struct", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.type", { fg = type_c, italic = true })
vim.api.nvim_set_hl(0, "@lsp.type.typeParameter", { fg = type_c, italic = true })
...
vim.api.nvim_set_hl(0, "@lsp.typemod.variable.defaultLibrary", { fg = variable_lang, italic = true })
...
vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", { fg = cursor, bold = true })
vim.api.nvim_set_hl(0, "LspCodeLens", { fg = comment })
vim.api.nvim_set_hl(0, "LspInlayHint", { fg = fg_gutter })
